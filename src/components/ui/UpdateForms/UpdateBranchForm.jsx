...
export default function UpdateBranchForm({ selectedUpdateBranch }) {
  ...
  const onSubmit = async (data) => {
    const branchData = {
      ...
      branchDivision: data.division,
      branchAddress: data.address,
      branchMapLink: data.mapLink,
      ...
      <form className="w-full max-w-md" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="form-control mb-3">
          ...
          <input
            ...
            defaultValue={selectedUpdateBranch.branchName}
        ...
        <div className="form-control mb-3">
          ...
          <input
            ...
            defaultValue={selectedUpdateBranch.branchAddress}
            className="input input-bordered input-primary w-full"
          />
          {errors.address && (
        ...
        <div className="form-control mb-3">
          ...
          <input
            ...
            defaultValue={selectedUpdateBranch.branchDivision}
            className="input input-bordered input-primary w-full"
          />
          {errors.division && (
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="form-control">
              ...
              <input
                ...
                defaultValue={selectedUpdateBranch.branchLocation?.lat}
            ...
            <div className="form-control">
              ...
              <input
                ...
                defaultValue={selectedUpdateBranch.branchLocation?.long}
                className="input input-bordered input-primary"
              />
              {errors.longitude && (
